    ...
    <div class="bg-gray-800 p-8 rounded-xl shadow-2xl w-full max-w-2xl border border-gray-700">
      ...
      <div class="mb-8">
        ...
        <div class="input-group mb-6">
          <label for="initialAmount" class="block text-sm font-medium text-gray-300 mb-1">Initial Investment Amount ($)</label>
        ...
        <div class="input-group mb-6">
          <label for="feesCollected" class="block text-sm font-medium text-gray-300 mb-1">Total Fees Collected ($)</label>
      ...
      <!-- Validation Messages -->
      <div v-if="validationError" class="bg-red-800 border border-red-700 text-red-200 px-4 py-3 rounded-md mb-6" role="alert">
      ...
      <div class="mt-6 bg-gray-700 p-4 rounded-lg border border-gray-600">
        ...
        <p class="text-gray-400 text-sm mt-2">
          This calculation uses simple interest to annualize your liquidity pool returns, which is appropriate since fees are collected but not automatically reinvested.
        </p>
      </div>
    </div>
  </div>
